import 'package:firebasenew/QUIZ_APP/MOVIE/level3QuizMov.dart';
...
class Level2CompletionScreenMov extends StatelessWidget {
  final int level1Score;
  final int level2Score;

  Level2CompletionScreenMov({required this.level1Score, required this.level2Score});
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Level3MoviePage(),
