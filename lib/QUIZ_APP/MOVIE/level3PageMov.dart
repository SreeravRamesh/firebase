import 'package:firebasenew/QUIZ_APP/MOVIE/finalMovie.dart';
import 'package:flutter/material.dart';

class Level3CompletionScreenMov extends StatelessWidget {
  final int level1Score;
  final int level2Score;
  final int level3Score;

  Level3CompletionScreenMov({required this.level1Score, required this.level2Score, required this.level3Score});
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => FinalScoreScreenMov(
