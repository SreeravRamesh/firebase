import 'package:firebasenew/QUIZ_APP/MOVIE/level1PageMov.dart';
...
class MovieQuizPage extends StatefulWidget {
  @override
  _MovieQuizPageState createState() => _MovieQuizPageState();
}
...
class _MovieQuizPageState extends State<MovieQuizPage> {
  ...
  final List<Map<String, dynamic>> questions = [
    {
      "question": "Who is known as the 'Complete Actor' in Malayalam cinema?",
      "options": ["Mohanlal", "Mammootty", "Dileep", "Prithviraj"],
      "correct": "Mohanlal"
    },
    {
      "question": "Which was the first 3D movie in Malayalam cinema?",
      "options": ["Manichitrathazhu", "My Dear Kuttichathan", "Kilukkam", "Drishyam"],
      "correct": "My Dear Kuttichathan"
    },
    {
      "question": "Which Malayalam movie was remade in multiple languages, including Bollywood as 'Bhool Bhulaiyaa'?",
      "options": ["Manichitrathazhu", "Kilukkam", "Drishyam", "Bangalore Days"],
      "correct": "Manichitrathazhu"
    },
  ];
  ...
  void nextQuestion() {
    ...
    if (currentQuestionIndex < questions.length - 1) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => Level1CompletionScreenMov(score: score, totalQuestions: questions.length),
        ),
      );
    }
  }
    ...
    return Scaffold(
      ...
      body: Container(decoration: BoxDecoration(
          image: DecorationImage(
              image: AssetImage("Assets/images/movie2.jpg"),fit: BoxFit.fill)),
