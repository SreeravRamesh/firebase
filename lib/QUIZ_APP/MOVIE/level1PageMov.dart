import 'package:firebasenew/QUIZ_APP/MOVIE/level2QuizMov.dart';
import 'package:firebasenew/QUIZ_APP/SPORTS/level2Quiz.dart';
import 'package:flutter/material.dart';

class Level1CompletionScreenMov extends StatelessWidget {
  final int score;
  final int totalQuestions;

  Level1CompletionScreenMov({required this.score, required this.totalQuestions});
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Level2MoviePage(),
