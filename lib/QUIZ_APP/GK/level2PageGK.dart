import 'package:firebasenew/QUIZ_APP/GK/level3QuizGK.dart';
...
class Level2CompletionScreenGK extends StatelessWidget {
  final int level1Score;
  final int level2Score;

  Level2CompletionScreenGK({required this.level1Score, required this.level2Score});
