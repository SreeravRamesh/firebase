...
import 'package:lottie/lottie.dart'; // Import home screen

class FinalScoreScreenGK extends StatelessWidget {
  final int level1Score;
  final int level2Score;
  final int level3Score;

  FinalScoreScreenGK({required this.level1Score, required this.level2Score, required this.level3Score});
