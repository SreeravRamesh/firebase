...
class Level3CompletionScreen extends StatelessWidget {
  final int level1Score;
  final int level2Score;
  final int level3Score;

  Level3CompletionScreen({required this.level1Score, required this.level2Score, required this.level3Score});
