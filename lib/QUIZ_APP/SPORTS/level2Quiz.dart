...
class Level2SportsPage extends StatefulWidget {
  @override
  _Level2SportsPageState createState() => _Level2SportsPageState();
}

class _Level2SportsPageState extends State<Level2SportsPage> {
  ...
  final List<Map<String, dynamic>> questions = [
    ...
    {
      "question": "What is the length of a standard soccer field?",
      "options": ["100m", "105m", "110m", "120m"],
      "correct": "105m"
    },
    {
  ...
  void nextQuestion() {
    ...
    if (currentQuestionIndex < questions.length - 1) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => Level2CompletionScreen(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Sports Quiz - Level 2"),
      ),
      body: Padding(
