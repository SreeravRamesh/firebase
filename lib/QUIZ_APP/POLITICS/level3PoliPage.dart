import 'package:firebasenew/QUIZ_APP/POLITICS/finalPoli.dart';
import 'package:firebasenew/QUIZ_APP/SPORTS/finalSports.dart';
import 'package:flutter/material.dart';

class Level3CompletionScreenPoli extends StatelessWidget {
  final int level1Score;
  final int level2Score;
  final int level3Score;

  Level3CompletionScreenPoli({required this.level1Score, required this.level2Score, required this.level3Score});
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => FinalScoreScreenPoli(
