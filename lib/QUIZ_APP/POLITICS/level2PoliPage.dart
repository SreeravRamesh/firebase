import 'package:firebasenew/QUIZ_APP/POLITICS/level3QuizPoli.dart';
import 'package:flutter/material.dart';

class Level2CompletionScreenPoli extends StatelessWidget {
  final int level1Score;
  final int level2Score;

  Level2CompletionScreenPoli({required this.level1Score, required this.level2Score});
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Level3PoliticsPage(),
